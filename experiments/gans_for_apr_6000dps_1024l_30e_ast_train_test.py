...
import javalang
test_line = train_buggy_lines[2]
# test_line = "package javalang.brewtab.com; class Test {}"
print(test_line)
tree = javalang.parse.parse(test_line)
for path, node in tree:
    print(path, node)


# trees = []
# for line in tqdm(train_buggy_lines):
#     trees.append(javalang.parse.parse(line, ignore_errors=True))
